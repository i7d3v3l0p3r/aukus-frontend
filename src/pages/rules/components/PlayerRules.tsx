    ...
    content: [
      ...
      },
      {
        ...
        content: [
          ...
          'Можно комбинировать:',
          '0-10000 ₽ - 1 [1] шот / 30 [15] отжиманий / 50 [25] приседаний',
          '10.000-20.000 ₽ - 2 [1] шота / 60 [30] отжиманий / 100 [50] приседаний',
          '20.000-30.000 ₽ - 3 [2] шота / 90 [45] отжиманий / 150 [75] приседаний',
          '30.000-40.000 ₽ - 4 [2] шота / 120 [60] отжиманий / 200 [100] приседаний',
          '40.000-50.000 ₽ - 5 [3] шотов / 150 [75] отжиманий / 250 [125] приседаний',
          '50.000-70.000 ₽ - 6 [3] шотов / 180 [90] отжиманий / 300 [150] приседаний',
          '70.000-100.000 ₽ - 7 [4] шотов / 210 [105] отжиманий / 350 [175] приседаний',
          '100.000-140.000 ₽ - 8 [4] шотов / 240 [120] отжиманий / 400 [200] приседаний',
          '140.000-190.000 ₽ - 9 [5] шотов / 270 [135] отжиманий / 450 [225] приседаний',
          '190.000-240.000 ₽ - 10 [5] шотов / 300 [150] отжиманий / 500 [250] приседаний',
          '240.000-300.000 ₽ - 11 [6] шотов / 330 [175] отжиманий / 550 [275] приседаний',
