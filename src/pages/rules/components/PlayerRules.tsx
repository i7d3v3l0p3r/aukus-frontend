    ...
    content: [
      ...
      },
      {
        ...
        content: [
          ...
          'Для стратегий где можно проходить кампании на выбор, часы рассчитываются по формуле (количество пройденных кампаний) x (общее время игры) / (общее количество компаний). Учитываются только основные полноценные кампании',
        ],
      },
    ],
  },
