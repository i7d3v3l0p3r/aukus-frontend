    ...
    content: [
      {
        ...
        content: [
          ...
          'Один раз за аук можно изменить минимальный донат на любую сумму в предалх 100-500 ₽, по истечении аука стример обязан вернуть минималку на то значение, которое он выбрал в начале Аукуса',
      ...
      },
      {
        ...
        content: [
          ...
          'Для стратегий где можно проходить кампании на выбор, часы рассчитываются по формуле (количество пройденных кампаний) x (общее время игры) / (общее количество компаний)',
        ],
      },
    ],
  },
    ...
    content: [
      ...
      },
      {
        ...
        content: [
          ...
          'Игра пропогандирует (около) запрещенные темы, например S.T.A.L.K.E.R. 2',
    ...
    content: [
      {
        ...
        content: [
          ...
          '11 место - "идущий к реке". Пройти за раз со стримом 45000 шагов. Отдыхать разрешается',
        ],
      },
      {
