    ...
    content: [
      {
        ...
        content: [
          ...
          'Фиксированный минимальный донат (100-500р) выбирается стримером в начале аукуса и остается неизменным',
          'Один раз за аук можно изменить минимальный донат на любую сумму в предалх   100-500р, по истечении аука стример обязан вернуть минималку на то значение, которое он выбрал в начале Аукуса',
