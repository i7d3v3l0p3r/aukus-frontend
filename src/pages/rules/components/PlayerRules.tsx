...
const playerRules: Rule[] = [
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        content: [
          'Стример обязан выпить шоты крепкого алкоголя (не менее 35°), или отжаться или приседать количество раз по общей сумме аука, можно комбинировать:',
  ...
  },
  {
    ...
    content: [
      ...
      {
        title: 'Внести вклад в фонд на перстень',
        content: [
