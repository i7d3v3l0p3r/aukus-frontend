...
const rules = [
    ...
    content: [
      ...
      },
      {
        ...
        content: [
          ...
          'Результаты хода записываются в логах: название игры, результат броска кубика и короткий комментарий',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      ...
      {
        title: 'Логирование дропа',
        content: [
          'Название игры и результат броска записываются в логи, после чего начинается новый аукцион',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        content: [
          'Стример, прошедший 5 игр подряд, может провести просмотровый аукцион по своим правилам',
