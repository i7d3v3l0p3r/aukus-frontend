  ...
  return (
    <Box display="flex" justifyContent="center">
      <Box textAlign={'center'}>
        ...
        <Box marginTop={2} />
        <Typography variant="h5">Wabar (Ваки) — Графический дизайн</Typography>
        <Box marginTop={2} />
        <Typography variant="h5">CorruptedMushroom — Бекенд сервер</Typography>
        <Box marginTop={2} />
        <Typography variant="h5">olegsvs — Сайт, домен, хостинг</Typography>
        <Box marginTop={2} />
        <Typography variant="h5">gawk — Домен, хостинг</Typography>
        <Box marginTop={2} />
        <Typography variant="h5">madf12 — Фронтенд, канвас картинок</Typography>
        <Box marginTop={2} />
